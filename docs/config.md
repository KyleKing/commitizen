...
| `tag_format` | `str` | `None` | Format for the git tag. Useful for CalVer `"2021.01.02"` or for old projects that use a convention like `"v1.2.1"`. [See more](https://commitizen-tools.github.io/commitizen/bump/#tag_format) |
